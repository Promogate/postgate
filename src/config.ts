...
export const SCHEDULE_URL= process.env.NODE_ENV === "development" ? "https://n8n.postgate.app/webhook/develop_schedule" : "https://webhook.postgate.app/webhook/schedule"
